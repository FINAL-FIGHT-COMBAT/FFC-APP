  ...
  const DEMO_COMPONENTS = [
    {
      ...
      component: (
        <Box sx={contentStyles.grid()}>
          ...
          <ComponentBox title="Controllable states">
            <Autocomplete
              fullWidth
              value={value}
              options={OPTIONS}
          ...
          <ComponentBox title="Multiple values">
            <Autocomplete
              fullWidth
              multiple
              limitTags={3}
          ...
          <ComponentBox title="Sizes">
            ...
            <Autocomplete
              ...
              slotProps={{
                chip: { size: 'small', color: 'info', variant: 'soft' },
              }}
            />
          </ComponentBox>
        </Box>
    ...
    },
    {
      ...
      component: (
        <>
          ...
          <ComponentBox title="Output code" sx={{ my: 5 }}>
            <Box sx={{ gap: 1.5, width: 1, display: 'flex' }}>
              <CountrySelect
                displayValue="code"
                fullWidth
          ...
          <ComponentBox title="Variants" sx={contentStyles.grid(3)}>
