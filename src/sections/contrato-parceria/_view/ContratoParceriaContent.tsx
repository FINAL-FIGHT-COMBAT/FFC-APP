...
export function ContratoParceriaContent() {
  return (
    <>
      ...
      <Clause text="3.1. DEFINIÇÃO DAS COTAS DE PATROCÍNIO: A Empresa Parceira compromete-se com o fomento do evento por meio do aporte financeiro ou de permuta corporativa (barter), conforme cota patrocinadora selecionada: <DataTag label='COTA_PATROCINIO' fallback='[Cota Ouro, Prata, Bronze ou Permuta]' />. O cronograma de desembolso obedecerá às faturas geradas no ambiente financeiro do app FFC." />
      ...
      <Clause text="6.2. PENALIDADES FINANCEIRAS E ADMINISTRATIVAS: A quebra imotivada do contrato em prazo exíguo (inferior a 30 dias do evento) ou a inadimplência comercial acarretará multa compensatória prefixada em 30% do valor global da parceria. No campo administrativo, a sanção imporá o bloqueio imediato do perfil corporativo ('Shadowban') no aplicativo oficial, descredenciando a academia ou a empresa para edições futuras." />
