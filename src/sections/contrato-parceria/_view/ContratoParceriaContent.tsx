...
export function ContratoParceriaContent() {
  return (
    <>
      ...
      <ABNTText>
        Pelo presente instrumento particular, de um lado: <strong>ASPPIBRA – ASSOCIAÇÃO DOS PROPRIETÁRIOS E POSSUIDORES DE IMÓVEIS NO BRASIL</strong>, associação civil sem fins lucrativos, inscrita no CNPJ sob nº 26.325.396/0001-30, com sede em <DataTag label="ENDEREÇO DA SEDE" fallback="[Endereço da Sede]" />, neste ato representada por seu <DataTag label="CARGO DO REPRESENTANTE" fallback="[Cargo]" />, <DataTag label="NOME DO REPRESENTANTE" fallback="[Nome do Representante]" />, doravante denominada simplesmente <strong>ASPPIBRA</strong> ou <strong>INCUBADORA</strong>;
      </ABNTText>
      <ABNTText>
        e, de outro lado: <strong>PESSOA JURÍDICA PARCEIRA:</strong> <DataTag label="RAZÃO SOCIAL" fallback="[Razão Social]" />, nome fantasia <DataTag label="NOME FANTASIA" fallback="[Nome Fantasia]" />, inscrita no CNPJ sob nº <DataTag label="CNPJ" fallback="[CNPJ]" />, com sede em <DataTag label="ENDEREÇO COMPLETO DA SEDE" fallback="[Endereço Completo]" />, com registro de CNAE principal nº <DataTag label="CNAE PRINCIPAL" fallback="[CNAE]" />, neste ato representada por seu responsável legal <DataTag label="NOME DO REPRESENTANTE LEGAL" fallback="[Nome do Representante da Parceira]" />, portador do CPF nº <DataTag label="CPF DO REPRESENTANTE" fallback="[CPF]" />, doravante denominada simplesmente <strong>PARCEIRA</strong>;
      </ABNTText>
      <ABNTText>
