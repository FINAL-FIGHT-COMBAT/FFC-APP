      ...
      >
        ...
        >
          <A4Page pageNumber={1}>
            ...
            <ABNTText>
              Pelo presente instrumento particular, de um lado: <strong>ASPPIBRA – ASSOCIAÇÃO DOS PROPRIETÁRIOS E POSSUIDORES DE IMÓVEIS NO BRASIL</strong>, associação civil sem fins lucrativos, inscrita no CNPJ sob nº 26.325.396/0001-30, com sede em <DataTag text="ENDEREÇO DA SEDE" />, neste ato representada por seu Cofundador e Líder de Desenvolvimento e Parcerias, Sandro Antunes, doravante denominada simplesmente <strong>ASPPIBRA</strong> ou <strong>ORGANIZADORA</strong>;
            </ABNTText>
            <ABNTText>
              e, de outro lado: <strong>ATLETA CONVIDADO:</strong> <DataTag text="NOME COMPLETO" />, <DataTag text="NACIONALIDADE" />, <DataTag text="ESTADO CIVIL" />, <DataTag text="PROFISSÃO" />, portador do CPF nº <DataTag /> e RG nº <DataTag />, residente e domiciliado em <DataTag text="ENDEREÇO COMPLETO" />, doravante denominado simplesmente <strong>ATLETA</strong>;
            </ABNTText>
            <ABNTText>
