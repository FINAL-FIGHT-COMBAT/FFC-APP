...
export function ContratoAtletaContent() {
  return (
    <>
      ...
      <SectionTitle>CLÁUSULA 20ª – DA PROTEÇÃO DE DADOS PESSOAIS E PRIVACIDADE (LGPD)</SectionTitle>
      <Clause text="20.1. A ORGANIZADORA atuará como Controladora dos dados pessoais do ATLETA. Fornecedores externos (plataformas de inscrição, nuvem, transmissão, equipe médica e credenciamento) atuarão como Operadores quando tratarem dados em nome da ORGANIZADORA. O e-mail oficial do evento servirá como canal do Encarregado de Dados (DPO)." />
      <Clause text="20.2. Serão coletadas as seguintes categorias de dados: (i) cadastrais e de contato; (ii) financeiros; (iii) esportivos; (iv) dados sensíveis de saúde e aptidão física; (v) biometria (quando aplicável ao credenciamento); e (vi) registros de imagem e voz." />
      <Clause text="20.3. As finalidades específicas incluem: dados cadastrais para logística e credenciamento; financeiros para pagamento e prestação de contas; esportivos para elegibilidade e card; saúde para prevenção de risco e atendimento emergencial; e imagem/voz para divulgação e registro histórico." />
      <Clause text="20.4. O tratamento de dados comuns baseia-se na execução deste contrato e em procedimentos preliminares. O tratamento de dados sensíveis de saúde e biometria fundamenta-se na proteção da vida, na incolumidade física do ATLETA, na tutela da saúde e no consentimento específico quando aplicável, conforme o art. 11 da LGPD." />
      <Clause text="20.5. Os dados poderão ser compartilhados com terceiros (seguradoras, hospitais, plataformas de streaming, hotéis, companhias aéreas e fornecedores de gestão) exclusivamente para viabilizar o evento ou cumprir obrigação legal, exigindo-se dos Operadores o dever de confidencialidade, segurança e eliminação ao fim da relação." />
      <Clause text="20.6. Os dados contratuais e financeiros serão retidos pelo prazo legal aplicável (fins fiscais e de auditoria). Os dados médicos e de aptidão permanecerão pelo período necessário à defesa de responsabilidade. As mídias e registros de imagem seguirão o prazo estipulado na Cláusula 18. Ao término, os dados serão eliminados ou anonimizados." />
      <Clause text="20.7. O ATLETA titular dos dados possui o direito de solicitar confirmação de tratamento, acesso, correção, anonimização, bloqueio, eliminação e informação sobre compartilhamentos por meio do canal oficial de atendimento do Encarregado." />
      <Clause text="20.8. A ORGANIZADORA implementará medidas técnicas e administrativas de segurança, incluindo controle de acesso, trilha de auditoria e limitação de perfis, visando proteger os dados pessoais contra acessos não autorizados e situações acidentais ou ilícitas de destruição, perda ou alteração." />
      <Clause text="20.9. Em caso de suspeita ou confirmação de incidente de segurança que possa acarretar risco ou dano relevante aos titulares, a ORGANIZADORA comunicará a Autoridade Nacional de Proteção de Dados (ANPD) e o ATLETA afetado, em linguagem clara, informando a natureza do incidente e as medidas adotadas." />
      <Clause text="20.10. Caso o evento utilize plataformas de streaming, cloud computing ou ferramentas hospedadas fora do Brasil, fica autorizada a transferência internacional de dados, desde que o país de destino proporcione grau de proteção adequado ou o fornecedor adote salvaguardas contratuais equivalentes à LGPD." />
      <Clause text="20.11. As disposições desta cláusula e a própria Lei Geral de Proteção de Dados Pessoais (Lei nº 13.709/2018) prevalecem sobre qualquer política interna, regulamento ou anexo que venha a contrariar suas garantias e princípios." />
      ...
      <SectionTitle>CLÁUSULA 26ª – DO CASO FORTUITO, FORÇA MAIOR E REMARCAÇÃO</SectionTitle>
      <Clause text="26.1. Haverá caso fortuito ou força maior quando fato externo, imprevisível ou inevitável (ex: eventos climáticos severos, pane estrutural, falta de energia, interdição do local, ordem de autoridade pública ou risco coletivo) inviabilizar o evento total ou parcialmente, isentando as partes de responsabilidade por perdas e danos decorrentes, nos termos do art. 393 do Código Civil." />
      <Clause text="26.2. Ocorrendo o evento de força maior, a ORGANIZADORA comunicará os ATLETAS em até 24 (vinte e quatro) horas, e terá até 72 (setenta e duas) horas para apresentar a decisão oficial entre remarcar, reestruturar ou cancelar o evento." />
      <Clause text="26.3. Havendo REMARCAÇÃO: A vaga e a bolsa original do ATLETA ficam garantidas. O custeio de despesas logísticas adicionais (hospedagem e transporte) obedecerá à Matriz Financeira de Força Maior anexa. Caso o ATLETA comprove impossibilidade de comparecer à nova data, haverá liberação amigável da vaga, sem multas para nenhuma das partes." />
      <Clause text="26.4. Havendo CANCELAMENTO DEFINITIVO por força maior: Cada parte suportará seus próprios custos logísticos já consumidos por terceiros. Caso o ATLETA já tenha cumprido etapas essenciais (viagem, corte de peso, participação em mídia oficial) e esteja à disposição do evento no local, fará jus ao recebimento de um percentual de garantia da Bolsa, liquidado de forma objetiva conforme a Matriz Financeira de Força Maior." />
      <Clause text="26.5. Cancelamento por fato imputável exclusivamente à ORGANIZADORA (ausência de força maior) ensejará o pagamento integral da Bolsa de Luta ao ATLETA que tiver cumprido integralmente suas obrigações (batido o peso e comparecido), não se aplicando as escusas desta cláusula." />
      <Clause text="26.6. Caso a remarcação torne a obrigação excessivamente onerosa para qualquer das partes, estas comprometem-se a buscar renegociação de boa-fé antes de promover a resolução do contrato, à luz dos arts. 478 a 480 do Código Civil." />
      <Clause text="26.7. Todos os cenários econômicos decorrentes de alteração do evento por força maior obedecerão de forma vinculante ao Anexo da Matriz Financeira de Força Maior, sendo vedado à ORGANIZADORA alterar unilateralmente o núcleo econômico por meio de comunicado posterior genérico." />
