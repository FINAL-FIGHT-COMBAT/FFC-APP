    ...
    <>
      ...
      <PdfViewerLayout documentTitle={`${docConfig.title}_FFC`}>
        <A4Page pageNumber={1} headerContent={<DefaultHeader />} footerContent={<DefaultFooter />}>
          <Box sx={{ mb: 8 }}>
            <DocumentTitle>{docConfig.title}</DocumentTitle>
          </Box>
          ...
          <ABNTText sx={{ textAlign: 'center', mt: 6, fontWeight: 'bold' }}>
            Este documento está passando por revisão jurídica e técnica para garantir total
            alinhamento e segurança jurídica com as regras oficiais do Final Fight Combat.
          </ABNTText>
        </A4Page>
      </PdfViewerLayout>
    </>
