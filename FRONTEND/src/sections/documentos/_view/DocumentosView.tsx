    ...
    <StandardPageWrapper>
      <Container maxWidth="lg">
        ...
        <Stack spacing={3} sx={{ mb: { xs: 6, md: 10 }, textAlign: 'center' }}>
          ...
          >
            Acesso centralizado a todos os regulamentos esportivos, políticas de privacidade, termos
            de saúde e contratos oficiais do ecossistema FFC.
          </Typography>
        </Stack>
                  ...
                  >
                    ...
                    <Stack direction="row" alignItems="flex-start" spacing={2}>
                      ...
                      <Stack spacing={0.5} flexGrow={1}>
                        <Typography
                          variant="caption"
                          sx={{ color: 'text.disabled', textAlign: 'right', display: 'block' }}
                        >
                          {doc.size}
                        </Typography>
                        <Typography
                    ...
                    <Typography
                      variant="body2"
                      sx={{ color: 'rgba(255,255,255,0.5)', lineHeight: 1.5, flexGrow: 1 }}
                    >
                      {doc.description}
                    </Typography>
